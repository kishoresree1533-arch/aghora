...
const contactInfo = [
  ...
  },
  {
    ...
    detail: "info@aghoraengineeringconsultants.com",
    footer: "WE REPLY WITHIN 24 HOURS",
    color: "purple",
    content: ["info@aghoraengineeringconsultants.com", "projects@aghoraengineeringconsultants.com"],
    links: ["mailto:info@aghoraengineeringconsultants.com", "mailto:projects@aghoraengineeringconsultants.com"],
  },
  {
    icon: MapPin,
    title: "Visit Us",
