...
const courses = [
  {
    ...
    topics: [
      ...
      "Scope and objectives of HVAC design",
      "Modes of heat transfer (conduction, convection, radiation)",
      "HVAC standards and terminology",
      "Refrigeration fundamentals",
      "Tonnage of refrigeration and basic cycles",
      "Types of refrigeration systems",
      "Central air conditioning systems",
      "Package air conditioning systems",
      "Other system classifications (split, ducted systems)",
      "Types of duct and duct materials",
      "SMACNA standards for ductwork",
      "Ventilation layouts for spaces (toilet, car parking)",
      "Basic concepts of supply/return/vent routing",
      "AutoCAD 2D basics (drawing, editing, dimensioning)",
      "Fundamentals of HVAC (Basics, Scope, Standards)",
      "Modes of Heat Transfer (Conduction/Convection/Radiation)",
      "HVAC Standards and Terminology",
      "Refrigeration Fundamentals & Principles",
      "Tonnage of Refrigeration and Basic Cycles",
      "Types of Refrigeration Systems & Refrigerators",
      "HVAC System Types (Central, Package, Split, Ducted)",
      "VRF/VRV & Chiller ITS Piping Systems",
      "Duct Design, Materials & SMACNA Standards",
      "Ventilation Layouts (Toilet, Car Parking)",
      "Supply/Return/Vent Routing Concepts",
      "AutoCAD 2D Basics for HVAC Drafting",
      "HVAC-specific Drafting (Layout & Symbols)",
      "Practical Drafting Projects (Main Project)",
      "HVAC Design Tools like HAP (Load Calculation)",
      "Exposure to Drafting & Calculation Software",
      "Understanding AC & Ventilation Systems",
      "Planning HVAC Ducting & Load Calculation",
      "Hands-on AutoCAD software for HVAC drafting",
      "Heat load calculation (E-20 Excel sheet)",
